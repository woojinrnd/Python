...
class LoadWebcam:  # for inference
    ...
    def __init__(self, pipe='0', pipe2 = '1', img_size=416, stride=32):
        self.img_size = img_size
        self.stride = stride
        self.pipe = eval(pipe) if pipe.isnumeric() else pipe #Origin_1cam
        ...
        self.stride = stride
        self.pipe2 = eval(pipe2) if pipe2.isnumeric() else pipe2 #kwj_0915 2cam
        self.cap2 = cv2.VideoCapture(self.pipe2) #2cam
    ...
    def __next__(self):
        ...
        ret_val_2, img0 = self.cap2.read() #2cam
        img0 = cv2.flip(img0, 1)  # flip left-right  #2cam
        ...
        assert ret_val_2, f'Camera Error {self.pipe2}'
        img_path = 'webcam2.jpg'
        s = f'webcam {self.count}'
